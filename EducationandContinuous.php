...
// Requête SQL pour récupérer les coachs qui ont lancé un enseignement pour le cours "Education and Continuous Learning"
$query = $db->prepare("
    ...
    WHERE cours.nom_cours = 'Education and Continuous Learning'
");
$query->execute();
...
<nav class="navbar navbar-expand-lg container-fluid" style="position: fixed ; margin-top: -9%; z-index: 1; ">
    ...
    <div class="container mt-5">
        <h3 id="join_titre" class="text-center" style="margin-top:10%">Education and Continuous Learning</h3>
                ...
                <article class="card__article">
                    ...
                    <div class="card__data">
                        ...
                        <div style="display: flex;">
                            ...
                            href="about_coach.php?prenom=<?php echo urlencode($coach['prenom']); ?>&nom=<?php echo urlencode($coach['nom']); ?>&email=<?php echo urlencode($coach['email']); ?>&cours=<?php echo urlencode($coach['nom_cours']); ?>&prix=<?php echo urlencode($coach['prix']); ?>" class="btn btn-primary btn-block" style="width: 50%; height: 5%; margin-top: 0%;">
